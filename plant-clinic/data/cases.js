  ...
  rose_rust: {
    ...
    hotspots: [
      ...
      { id: "leaf_under", name: "Underside of leaves", nx: 0.73, ny: 0.34,
        ...
        flip: { label: "Flip the leaf over", text: "Raised orange-brown powdery pustules cluster along the underside of the leaf.", clue: "leaf_under" },
        clue: null },
  ...
  basil_downy_mildew: {
    ...
    hotspots: [
      ...
      { id: "downy_under", name: "Gray-purple leaf underside", nx: 0.83, ny: 0.36,
        ...
        flip: { label: "Turn the leaf underside up", text: "Fine gray-purple fuzzy growth follows the veins on the underside of the leaf.", clue: "downy_under" },
        clue: null },
